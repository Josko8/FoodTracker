...
//  FoodTracker
//
//  Created by Josip Mirkovic on 2018-05-06.
...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    func loadSampleData(){
        ...
        guard let meal1 = Meal(name: "Potato", photo: photo1, rating: 2) else {
            fatalError("Unable to initialize meal1")
        }
        guard let meal2 = Meal(name: "Banana", photo: photo2, rating: 3) else {
            fatalError("Unable to initialize meal2")
        }
        guard let meal3 = Meal(name: "Kitkat", photo: photo3, rating: 5) else {
